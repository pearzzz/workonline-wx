<template>
	<view class="page">
		<swiper circular="true" interval="8000" duration="1000" class="swiper">
			<swiper-item>
				<image mode="widthFix" src="https://emos-wx-1310426559.cos.ap-beijing.myqcloud.com/banner/swiper-1.jpg">
				</image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://emos-wx-1310426559.cos.ap-beijing.myqcloud.com/banner/swiper-2.jpg">
				</image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://emos-wx-1310426559.cos.ap-beijing.myqcloud.com/banner/swiper-3.jpg">
				</image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://emos-wx-1310426559.cos.ap-beijing.myqcloud.com/banner/swiper-4.jpg">
				</image>
			</swiper-item>
			<swiper-item>
				<image mode="widthFix" src="https://emos-wx-1310426559.cos.ap-beijing.myqcloud.com/banner/swiper-5.jpg">
				</image>
			</swiper-item>
		</swiper>
